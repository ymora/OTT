...
export default function TimeTrackingDashboard() {
  ...
  const [sections, setSections] = useState({ stats: true, charts: true, table: false })
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="h-40">
                    <Doughnut data={maximeActivityChartData} options={activityChartOptions} />
                  </div>
                ...
                <div>
                  ...
                  <div className="h-40">
                    <Doughnut data={yannickActivityChartData} options={activityChartOptions} />
                  </div>
                  <div className="text-xs text-gray-500 mt-2 text-center">
