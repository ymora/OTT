...
constopenCreateModal = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      < className="flex flex-col md:flex-row gap-3"        <div className="flex1">
          <SearchBar
           value={searchTerm}
            onChange={setSearchTerm}
            placeholder="Rechercher un utilisaur..."
          />
        </div>
        <div className="fle iemscente gap-2">
          <button 
      ...
      <div className="card">
        ...
        {loading ? (
          <LoadnSpinner size="lg" text="Cargement des utilisateurs..." />
        ) : (
          <div className="overflow-x-auo">
            <table className="wfull">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th className="text-left py-3 px-4 text-gra-700 dark:text-gray-300">Nom</th>
