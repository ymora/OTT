# 🚀 Configuration Render - Maxime

## 🎯 Ton service personnel

- **Nom** : `ott-dashboard-maxime`
- **URL** : https://ott-dashboard-maxime.onrender.com
- **Branche** : `maxime`
...
NEXT_PUBLIC_API_URL=https://ott-dashboard-maxime.onrender.com
...
AUTH_DISABLED=false
CORS_ALLOWED_ORIGINS=https://ott-dashboard-maxime.onrender.com,https://ott-jbln.onrender.com,https://ott-dashboard-yannick.onrender.com
...
### **URLs**
- **Ton service** : https://ott-dashboard-maxime.onrender.com
- **API Health** : https://ott-dashboard-maxime.onrender.com/api.php/health
- **Production** : https://ott-jbln.onrender.com
- **Service Yannick** : https://ott-dashboard-yannick.onrender.com
...
### **Logs Render**
- Dashboard → Services → ott-dashboard-maxime → Logs
- Temps réel : `tail -f`

### **Métriques**
- Dashboard → Services → ott-dashboard-maxime → Metrics
- CPU, mémoire, réseau
