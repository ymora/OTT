...
/**
 * Construit un chemin avec le basePath pour les assets statiques
 * Note: Pour la navigation, utiliser le router Next.js qui gère automatiquement le basePath
 * @param {string} path - Chemin relatif (ex: '/manifest.json')
 * @returns {string} Chemin avec basePath
 */
